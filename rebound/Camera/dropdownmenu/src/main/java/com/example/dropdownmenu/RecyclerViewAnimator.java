...
public class RecyclerViewAnimator {
    ...
    public RecyclerViewAnimator(RecyclerView recyclerView) {
        ...
        mWeight = mRecyclerView.getResources().getDisplayMetrics().widthPixels;
    ...
    private void slideInBottom(final View item, final int delay, final int tension, final int friction) {
        // Move item far outside the RecyclerView
        item.setTranslationX(mWeight);
            ...
            public void run() {
                ...
                spring.addListener(new SimpleSpringListener() {
                    ...
                    public void onSpringUpdate(Spring spring) {
                         ...
                         */
                        float val = (float) (mWeight - spring.getCurrentValue());
